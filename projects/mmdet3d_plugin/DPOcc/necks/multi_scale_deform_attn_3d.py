...
# def GDtranss1(a):
#     # sampling_offsets[2,37376,8,3,4,3]
...
#
# def GDtranss(a):
#     a_split = torch.split(a, 2, dim=2)
#     head_mean0 = torch.mean(a_split[0])
#     a1 = torch.add(head_mean0, a_split[1])
#     head1 = torch.concat([a_split[0], a1], dim=2)
#     head_mean1 = torch.mean(head1)
#     a2 = torch.add(head_mean1, a_split[2])
#     head2 = torch.concat([head1, a2], dim=2)
#     head_mean2 = torch.mean(head2)
#     a3 = torch.add(head_mean2, a_split[3])
#     a = torch.concat([a_split[0], a1, a2, a3], dim=2)
#     return a
...
class MultiScaleDeformableAttention3D(BaseModule):
    ...
    def forward(self,
        ...
        # sampling_offsets = GDtranss(sampling_offsets)
