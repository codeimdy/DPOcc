...
if __name__ == "__main__":
    ...
    if args.vis_train:
        pkl_path = '/media/hanyong/zgw/chk/TPVFormer-main/data/nuscenes_infos_train.pkl'
    else:
        pkl_path = '/media/hanyong/zgw/chk/TPVFormer-main/data/nuscenes_infos_val.pkl'
    
    data_path = '/media/hanyong/zgw/chk/TPVFormer-main/data/nuscenes'
