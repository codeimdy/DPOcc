...
model = dict(
    ...
    img_bev_encoder_backbone=dict(
        ...
        with_cp=True,
        voxel_height=occ_size[2] // lss_downsample[2],
...
data_root = '/media/hanyong/zgw/chk/SparseOcc-main/data/nuscenes'
...
train_pipeline = [
    dict(type='LoadMultiViewImageFromFiles_DPOcc', is_train=True, 
...
test_pipeline = [
    dict(type='LoadMultiViewImageFromFiles_DPOcc', is_train=False,
            data_config=data_config, img_norm_cfg=img_norm_cfg),
