...
model = dict(
    ...
    img_backbone=dict(
        ...
        with_cp=True,
        init_cfg=dict(type='Pretrained', prefix='backbone', checkpoint='/media/hanyong/zgw/chk/DPOcc/ckpts/efficientnet-b7_3rdparty_8xb32-aa_in1k_20220119-bf03951c.pth'),
    ),
    img_neck=dict(
        type='SECONDFPN',
